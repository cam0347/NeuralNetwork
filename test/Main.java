...
public class Main {
    public static void main(String[] args) {
        ...
        NeuralNetwork nn = new NeuralNetwork(data, data, new NNParameters(4, new int[] {4, 4}, 200, 0.0001, true, new NNActivation[] {NNActivation.LINEAR, NNActivation.LINEAR}, NNError.MAE));
        nn.train();
